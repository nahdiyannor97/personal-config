...
* **Initialization:** Before processing this specification, you MUST read `agent.yaml` and read all rules inside `agents/` directory (e.g., `rules-core.md`, `rules-ponytail.md`).
